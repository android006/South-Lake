  ...
  render() {
    return (
      <div className={styles.bg}>
        ...
        <div className={styles.Dot20}></div>
        ...
        <div className={styles.Block20}></div>
        <div className={styles.Block21}></div>
        <div className={styles.Block22}></div>
        <div className={styles.Block23}></div>
        <div className={styles.Block24}></div>
        <div className={styles.Block25}></div>
        <div className={styles.Block26}></div>
        <div className={styles.Block27}></div>
        <div className={styles.Block28}></div>
        <div className={styles.Block29}></div>
        <div className={styles.Block30}></div>
        <div className={styles.Block31}></div>
      </div>
    );
  }
}
